[![Build Status](https://travis-ci.org/it-shark-pro/js-assignments.svg?branch=master)](https://travis-ci.org/PaWellOn/js-assignments)
![Hackage-Deps](https://img.shields.io/hackage-deps/v/lens.svg)
[![Greenkeeper badge](https://badges.greenkeeper.io/it-shark-pro/js-assignments.svg)](https://greenkeeper.io/)
[![GitHub release](https://img.shields.io/github/release/it-shark-pro/js-assignments.svg)](https://github.com/PaWellOn/js-assignments/releases/latest)
...
```
* Open https://github.com/PaWellOn/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
